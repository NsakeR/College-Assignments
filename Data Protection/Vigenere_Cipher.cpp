...
//  Autor: Jakub Lefik
//  Wersja: 1.0 
//  Desc: Program realizuje szyfrowanie i deszyfrowanie Vigenera z podanym kluczem  15.03.2022
//
//////////////////////////////////////////////////////////
...
#include <fstream>
#include <string>
static double f[26] = { 0.08087, 0.01493, 0.02781, 0.04253, 0.12702, 0.02228, 0.02015, 0.06094, 0.06966, 0.00153, 0.00772, 0.04094, 0.02587, 0.06749, 0.07507, 0.01929, 0.00096, 0.05987, 0.06234, 0.09056, 0.02758, 0.00978, 0.02360, 0.00150, 0.01974, 0.00074 };
...
int main()
{
    std::cout << "Witam w szyfrowaniu Vigenera" << std::endl;
    ...
    while (true) {
        ...
        case 1:
            ...
            std::cin >> stringkey;
            temp = stringkey.length();

            stringkey.resize(message.length());

            for (int z = 0; z < stringkey.length() - temp; z++) {
                stringkey[temp + z] = stringkey[z];
            }

            i = 0;
            while (message[i] != '\0' && i < 2500)
            {
                message[i] = cezar(message[i], stringkey[i]);
                i++;
            }
            i = 0;
        ...
        case 2:
            ...
            while (message[i] != '\0' && i < 2500)
            {
                message[i] = decipher(message[i], stringkey[i]);
                i++;
            }
            i = 0;
            while (message[i] != '\0' && i < 2500)
